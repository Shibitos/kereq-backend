...
public interface ParamKey {
    ...
    String IMG_DIR_DIV_MAX_LEVEL = "kereq.img.dir_div_max_level";
    String IMG_STORAGE_PATH = "kereq.img.storage_path";
    String IMG_MIN_SIZE = "kereq.img.min_size";
    String THUMBNAIL_SIZE = "kereq.img.thumbnail_size";
